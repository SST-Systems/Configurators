...
{
    /// <summary>
    /// Resolves the handler-based conditions of a <see cref="ConditionProcessor"/>, recursively binding pooled
    /// handlers to their serialized data including nested composites. See <see cref="ConditionManager"/> for the
